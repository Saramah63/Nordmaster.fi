import { ArrowRight, Award, Hammer, ThumbsUp } from 'lucide-react';
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-slate-900">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1771337742731-91a885ccfc5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZXRhbCUyMGZhYnJpY2F0aW9uJTIwc3RlZWwlMjBzdHJ1Y3R1cmV8ZW58MXx8fHwxNzcyNTU2MzgzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
